    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <div className="bg-white border-b border-zinc-100">
        <div className="max-w-lg mx-auto px-6 py-12 text-center">
          <span className="inline-block rounded-full bg-orange-50 px-3 py-1 text-xs font-semibold text-orange-500 mb-4">
            피트니스 사업자 전용
          </span>
          <h1 className="text-3xl font-black text-zinc-900 leading-tight">
            당신의 실제 순이익,<br />
            <span className="text-orange-500">지금 바로 확인하세요</span>
          </h1>
