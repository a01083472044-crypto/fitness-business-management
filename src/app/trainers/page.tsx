            ...
            <div className="space-y-3">
              ...
              {(form.salaryType === "base+rate" || form.salaryType === "rate") && (
                <div>
                  ...
                  <div className="relative">
                    <input
                      type="number" min="10" max="100" step="1" placeholder="50"
                      value={form.commRate || ""}
                  ...
                  <input type="range" min="10" max="100" value={form.commRate}
                    onChange={(e) => setForm({ ...form, commRate: Number(e.target.value) })}
                    className="w-full accent-blue-600 mt-2" />
                  <div className="flex justify-between text-xs text-zinc-400 mt-1">
                    <span>10%</span><span className="text-blue-600">40~60% 권장</span><span>100%</span>
                  </div>
                </div>
              )}
